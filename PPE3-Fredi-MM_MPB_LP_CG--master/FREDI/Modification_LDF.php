...
<html lang="fr">
    ...
    <?php include "menu.php";?>
        ...
        <div class="py-5 text-center">
                ...
                <h2>Modification d'une ligne de frais</h2>
                <p class="lead">Changez vos informations pour permettre de modifier votre ligne.</p>
            </div>
